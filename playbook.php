    ...
    <body>
        ...
        <header class="page-header">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h1 class="text-white">Notre playbook</h1>
                            <p class="text-white lead">À mi-chemin entre des valeurs parfois trop conceptuelles et des principes souvent trop restrictifs, notre playbook est le reflet de notre philosophie. Chaque Thiguy s'y réfère quand il est amené à prendre une décision.</p>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <h1 class="">Le playbook de Thiga</h1>
                        </div>
                    </div>
                    <div class="row">
